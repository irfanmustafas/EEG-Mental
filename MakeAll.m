...
for p = 1:pSize(1)
    ...
    for q = 1:5
        ...
        for t = 1:sm(2)
            ...
            pMatrix(:,t,4,1) = nanmean(btLWav{6}(:,iStart1(t):i3End1(t)), 2);
            pMatrix(:,t,4,2) = nanmean(btLWav{6}(:,iStart1(t):i5End1(t)), 2);
            pMatrix(:,t,4,3) = nanmean(btLWav{6}(:,iStart2(t):i3End2(t)), 2);
            pMatrix(:,t,4,4) = nanmean(btLWav{6}(:,iStart2(t):i5End2(t)), 2);
            pMatrix(:,t,4,5) = nanmean(btLWav{6}(:,iStart3(t):i3End3(t)), 2);
            pMatrix(:,t,4,6) = nanmean(btLWav{6}(:,iStart3(t):i5End3(t)), 2);
            pMatrix(:,t,4,7) = nanmean(btLWav{6}(:,iStartM(t):iEndM(t)), 2);
            pMatrix(:,t,4,8) = nanmean(btLWav{6}(:,iStart1(t):iEnd(t)), 2);
            
            pMatrix(:,t,6,1) = nanmean(btHWav{6}(:,iStart1(t):i3End1(t)), 2);
            pMatrix(:,t,6,2) = nanmean(btHWav{6}(:,iStart1(t):i5End1(t)), 2);
            pMatrix(:,t,6,3) = nanmean(btHWav{6}(:,iStart2(t):i3End2(t)), 2);
            pMatrix(:,t,6,4) = nanmean(btHWav{6}(:,iStart2(t):i5End2(t)), 2);
            pMatrix(:,t,6,5) = nanmean(btHWav{6}(:,iStart3(t):i3End3(t)), 2);
            pMatrix(:,t,6,6) = nanmean(btHWav{6}(:,iStart3(t):i5End3(t)), 2);
            pMatrix(:,t,6,7) = nanmean(btHWav{6}(:,iStartM(t):iEndM(t)), 2);
            pMatrix(:,t,6,8) = nanmean(btHWav{6}(:,iStart1(t):iEnd(t)), 2);
